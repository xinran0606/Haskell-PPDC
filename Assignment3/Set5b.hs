...
treeMax Empty = 0
treeMax (Node a b c) = max a (max (treeMax b) (treeMax c))
...
allValues cond (Node a b c) = cond a && allValues cond b && allValues cond c 
...
mapTree oper Empty = Empty
mapTree oper (Node a b c) = (Node (oper a) (mapTree oper b) (mapTree oper c))
